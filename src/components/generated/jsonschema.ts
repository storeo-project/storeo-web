...
const jsonSchema: Schema = {
  ...
  deleteMultiUser: {
    input: {
      type: 'object',
      properties: {
        ids: { type: 'array', items: { type: ['integer', 'null'] } },
      },
      additionalProperties: false,
      definitions: {},
      required: ['ids'],
    ...
    input: {
      ...
      definitions: {
        db_userUpdateInput: {
          ...
          properties: {
            email: {
              $ref: '#/definitions/db_StringFieldUpdateOperationsInput',
            },
            phoneNumber: {
              $ref: '#/definitions/db_StringFieldUpdateOperationsInput',
            },
            ...
            shop_user: {
              $ref: '#/definitions/db_shop_userUpdateManyWithoutUserInput',
            },
          },
        },
        ...
        db_shop_userUpdateManyWithoutUserInput: {
          ...
          properties: {
            create: {
              $ref: '#/definitions/db_shop_userCreateWithoutUserInput',
            },
            connectOrCreate: {
              $ref: '#/definitions/db_shop_userCreateOrConnectWithoutUserInput',
            },
            upsert: {
              $ref: '#/definitions/db_shop_userUpsertWithWhereUniqueWithoutUserInput',
            },
            createMany: {
              $ref: '#/definitions/db_shop_userCreateManyUserInputEnvelope',
            },
            ...
            update: {
              $ref: '#/definitions/db_shop_userUpdateWithWhereUniqueWithoutUserInput',
            },
            updateMany: {
              $ref: '#/definitions/db_shop_userUpdateManyWithWhereWithoutUserInput',
            },
        ...
        db_shop_userCreateWithoutUserInput: {
          ...
          properties: {
            ...
            shop: {
              $ref: '#/definitions/db_shopCreateNestedOneWithoutShop_userInput',
            },
          },
        },
        db_shopCreateNestedOneWithoutShop_userInput: {
          ...
          properties: {
            create: {
              $ref: '#/definitions/db_shopCreateWithoutShop_userInput',
            },
            connectOrCreate: {
              $ref: '#/definitions/db_shopCreateOrConnectWithoutShop_userInput',
            },
        ...
        db_shop_userWhereUniqueInput: {
          ...
          properties: {
            user_id_shop_id: {
              $ref: '#/definitions/db_shop_userUser_idShop_idCompoundUniqueInput',
            },
          },
        },
        ...
        db_shop_userUpsertWithWhereUniqueWithoutUserInput: {
          ...
          properties: {
            where: { $ref: '#/definitions/db_shop_userWhereUniqueInput' },
            update: {
              $ref: '#/definitions/db_shop_userUpdateWithoutUserInput',
            },
            create: {
              $ref: '#/definitions/db_shop_userCreateWithoutUserInput',
            },
        ...
        db_shop_userUpdateWithoutUserInput: {
          ...
          properties: {
            assigned_at: {
              $ref: '#/definitions/db_DateTimeFieldUpdateOperationsInput',
            },
            assigned_by: {
              $ref: '#/definitions/db_StringFieldUpdateOperationsInput',
            },
            ...
            shop: {
              $ref: '#/definitions/db_shopUpdateOneRequiredWithoutShop_userInput',
            },
          },
        },
        ...
        db_shopUpdateOneRequiredWithoutShop_userInput: {
          ...
          properties: {
            ...
            upsert: {
              $ref: '#/definitions/db_shopUpsertWithoutShop_userInput',
            },
            connect: { $ref: '#/definitions/db_shopWhereUniqueInput' },
            update: {
              $ref: '#/definitions/db_shopUpdateWithoutShop_userInput',
            },
          },
        },
        ...
        db_shopUpdateWithoutShop_userInput: {
          ...
          properties: {
            ...
            deleted: {
              $ref: '#/definitions/db_BoolFieldUpdateOperationsInput',
            },
            created_at: {
              $ref: '#/definitions/db_DateTimeFieldUpdateOperationsInput',
            },
        ...
        db_shop_userCreateManyUserInputEnvelope: {
          ...
          properties: {
            data: {
              type: 'array',
              items: { $ref: '#/definitions/db_shop_userCreateManyUserInput' },
            },
        ...
        db_shop_userScalarWhereInput: {
          ...
          properties: {
            ...
            OR: {
              type: ['array', 'null'],
              items: { $ref: '#/definitions/db_shop_userScalarWhereInput' },
            },
